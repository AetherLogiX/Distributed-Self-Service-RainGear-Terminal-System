...
public:
    ...
    double get_deposit() const override { return 20.00; } // 普通塑料伞押金20元

    QString get_iconpath() const override { return ":/rgears_icons/plastic_umbrella.png"; } //返回图标路径
};
...
public:
    ...
    double get_deposit() const override { return 50.00; } 
    QString get_iconpath() const override { return ":/rgears_icons/highquality_umbrella.png"; } 
};
...
public:
    ...
    QString get_iconpath() const override { return ":/rgears_icons/sunshade_umbrella.png"; } // 图标路径
};
...
public:
    ...
    QString get_iconpath() const override { return ":/rgears_icons/raincoat.png"; } // 图标路径
};